...
| # | Módulo                            | Status            |
|---|-----------------------------------|-------------------|
| 1 | Coleta no Pipeline (CI/CD)        | 🔄 Em construção  |
| 2 | Normalização ASU                  | ⏳ Pendente       |
| 3 | Priorização por Contexto IaC      | ⏳ Pendente       |
| 4 | DLP de Borda                      | ⏳ Pendente       |
| 5 | Remediação via Gemini API         | ⏳ Pendente       |
| 6 | Pull Request com Revisão Humana   | ⏳ Pendente       |
